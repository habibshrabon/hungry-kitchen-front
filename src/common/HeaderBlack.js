    ...
    <div className="header">
      <nav className="relative flex flex-wrap items-center justify-between px-2 py-3 mb-3">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          ...
          <div
            className={
              "heroSection2 lg:flex flex-grow items-center rounded-sm" +
          ...
          >
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto sm:p-2 items-center">
              ...
              <li className="nav-item">
                ...
                <span className="text-dark align-top ">
                  {addToCart.length}{" "}
                </span>
              </li>
              ...
              <li className="nav-item">
                {user.email ? (
                  ...
                  >
                    <NavLink
                      to="/register"
                      className="leading-lg rounded text-black bg-yellow-400 px-5 py-3 hover:bg-transparent hover:outline hover:text-black hover:outline-offset-2 hover:outline-2"
                    >
